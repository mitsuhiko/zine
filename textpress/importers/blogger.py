...
"""
    ...
    The textpress importer framework takes over once the dump is "enqueued"
    ...
    following:
        ...
        * Posts
        * Comments
        * Categories (called labels in TextPress)
    ...
    This is the process by which the blogger data is dumped into the TextPress
    import system. Essentially it involves creating a textpress.importers.Blog
    instance with the necessary data. Instances of textpress.importers.Post,
    testpress.importers.Author, textpress.importers.Comment and
    textpress.importers.Label are created.
...
def _create_blogger_service():
    ...
    blogger_service.source = 'TextPress_BloggerImporter-1.0'
