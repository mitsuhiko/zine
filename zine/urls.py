...
def make_urls(app):
    ...
    admin_urls = [
        ...
        Rule('/comments/', endpoint='admin/manage_comments', defaults={'page': 1}),
        ...
        Rule('/groups/', endpoint='admin/manage_groups', defaults={'page': 1}),
        Rule('/groups/page/<int:page>', endpoint='admin/manage_groups'),
