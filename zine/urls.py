...
def make_urls(app):
    ...
    admin_urls = [
        ...
        Rule('/p/<int:post_id>/comments/page/<int:page>/per-page/<any("20", "40", "60", "80", "100"):per_page>',
             endpoint='admin/show_post_comments'),
        Rule('/comments/', endpoint='admin/manage_comments',
             defaults={'page': 1, 'per_page': 20}),
        Rule('/comments/page/<int:page>/per-page/<any("20", "40", "60", "80", "100"):per_page>',
        ...
        Rule('/comments/unmoderated/page/<int:page>/per-page/<any("20", "40", "60", "80", "100"):per_page>',
             endpoint='admin/show_unmoderated_comments'),
        Rule('/comments/approved', defaults={'page': 1, 'per_page': 20},
             endpoint='admin/show_approved_comments'),
        Rule('/comments/approved/page/<int:page>/per-page/<any("20", "40", "60", "80", "100"):per_page>',
             endpoint='admin/show_approved_comments'),
        Rule('/comments/blocked', defaults={'page': 1, 'per_page': 20},
             endpoint='admin/show_blocked_comments'),
        Rule('/comments/blocked/page/<int:page>/per-page/<any("20", "40", "60", "80", "100"):per_page>',
             endpoint='admin/show_blocked_comments'),
        Rule('/comments/spam', defaults={'page': 1, 'per_page': 20},
             endpoint='admin/show_spam_comments'),
        Rule('/comments/spam/page/<int:page>/per-page/<any("20", "40", "60", "80", "100"):per_page>',
             endpoint='admin/show_spam_comments'),
