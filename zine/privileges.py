...
_register('CREATE_PAGES', lazy_gettext(u'can create new posts'))
_register('EDIT_OWN_PAGES', lazy_gettext(u'can edit his own posts'))
_register('EDIT_OTHER_PAGES', lazy_gettext(u'can edit another person\'s posts'))
